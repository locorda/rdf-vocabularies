...
/// AppendAction class from Schema vocabulary
///
...
/// - InsertAction (https://schema.org/InsertAction)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
/// - UpdateAction (https://schema.org/UpdateAction)
///
/// This class provides access to all properties that can be used with AppendAction.
/// [Class Reference](https://schema.org/AppendAction)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaAppendAction {
  // Private constructor prevents instantiation
  const SchemaAppendAction._();

  /// IRI term for the AppendAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/AppendAction');
