...
/// BankAccount class from Schema vocabulary
///
...
///
/// Equivalent to:
/// - BankAccount (https://spec.edmcouncil.org/fibo/ontology/FBC/ProductsAndServices/FinancialProductsAndServices/BankAccount)
///
/// This class provides access to all properties that can be used with BankAccount.
/// [Class Reference](https://schema.org/BankAccount)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaBankAccount {
  // Private constructor prevents instantiation
  const SchemaBankAccount._();

  /// IRI term for the BankAccount class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/BankAccount');
