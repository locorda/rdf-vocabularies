...
/// BedAndBreakfast class from Schema vocabulary
///
/// Bed and breakfast.
/// <br /><br />
...
///
/// This class provides access to all properties that can be used with BedAndBreakfast.
/// [Class Reference](https://schema.org/BedAndBreakfast)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaBedAndBreakfast {
  // Private constructor prevents instantiation
  const SchemaBedAndBreakfast._();

  /// IRI term for the BedAndBreakfast class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/BedAndBreakfast');
