...
/// DanceGroup class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with DanceGroup.
/// [Class Reference](https://schema.org/DanceGroup)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaDanceGroup {
  // Private constructor prevents instantiation
  const SchemaDanceGroup._();

  /// IRI term for the DanceGroup class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('https://schema.org/DanceGroup');
