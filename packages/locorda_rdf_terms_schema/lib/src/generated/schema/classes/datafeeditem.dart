...
/// DataFeedItem class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with DataFeedItem.
/// [Class Reference](https://schema.org/DataFeedItem)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaDataFeedItem {
  // Private constructor prevents instantiation
  const SchemaDataFeedItem._();

  /// IRI term for the DataFeedItem class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/DataFeedItem');
  ...
  /// dateDeleted [Expects: https://schema.org/Date, https://schema.org/DateTime]
  ///
