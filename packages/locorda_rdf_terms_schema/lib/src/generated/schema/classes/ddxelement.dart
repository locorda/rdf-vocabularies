...
/// DDxElement class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with DDxElement.
/// [Class Reference](https://schema.org/DDxElement)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaDDxElement {
  // Private constructor prevents instantiation
  const SchemaDDxElement._();

  /// IRI term for the DDxElement class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/DDxElement');
  ...
  /// distinguishingSign [Expects: https://schema.org/MedicalSignOrSymptom]
  ///
