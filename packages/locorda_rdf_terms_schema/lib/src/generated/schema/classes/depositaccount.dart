...
/// DepositAccount class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with DepositAccount.
/// [Class Reference](https://schema.org/DepositAccount)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaDepositAccount {
  // Private constructor prevents instantiation
  const SchemaDepositAccount._();

  /// IRI term for the DepositAccount class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/DepositAccount');

  /// accountMinimumInflow [Expects: https://schema.org/MonetaryAmount]
  ///
