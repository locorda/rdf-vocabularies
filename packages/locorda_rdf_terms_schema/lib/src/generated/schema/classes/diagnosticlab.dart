...
/// DiagnosticLab class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with DiagnosticLab.
/// [Class Reference](https://schema.org/DiagnosticLab)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaDiagnosticLab {
  // Private constructor prevents instantiation
  const SchemaDiagnosticLab._();

  /// IRI term for the DiagnosticLab class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/DiagnosticLab');
  ...
  /// availableTest [Expects: https://schema.org/MedicalTest]
  ///
