...
/// DrugStrength class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with DrugStrength.
/// [Class Reference](https://schema.org/DrugStrength)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaDrugStrength {
  // Private constructor prevents instantiation
  const SchemaDrugStrength._();

  /// IRI term for the DrugStrength class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/DrugStrength');
  ...
  /// availableIn [Expects: https://schema.org/AdministrativeArea]
  ///
  ...
  /// strengthUnit [Expects: https://schema.org/Text]
  ///
