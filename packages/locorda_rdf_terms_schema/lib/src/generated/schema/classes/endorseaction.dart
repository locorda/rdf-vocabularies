...
/// EndorseAction class from Schema vocabulary
///
...
/// - ReactAction (https://schema.org/ReactAction)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with EndorseAction.
/// [Class Reference](https://schema.org/EndorseAction)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaEndorseAction {
  // Private constructor prevents instantiation
  const SchemaEndorseAction._();

  /// IRI term for the EndorseAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/EndorseAction');
  ...
  /// endorsee [Expects: https://schema.org/Organization, https://schema.org/Person]
  ///
