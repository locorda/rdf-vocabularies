...
/// HighSchool class from Schema vocabulary
///
/// A high school.
///
/// Inherits from:
...
///
/// This class provides access to all properties that can be used with HighSchool.
/// [Class Reference](https://schema.org/HighSchool)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaHighSchool {
  // Private constructor prevents instantiation
  const SchemaHighSchool._();

  /// IRI term for the HighSchool class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('https://schema.org/HighSchool');
