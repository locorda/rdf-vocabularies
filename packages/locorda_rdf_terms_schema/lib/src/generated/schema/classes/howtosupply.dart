...
/// HowToSupply class from Schema vocabulary
///
/// A supply consumed when performing the instructions for how to achieve a result.
///
/// Inherits from:
/// - HowToItem (https://schema.org/HowToItem)
...
/// [Class Reference](https://schema.org/HowToSupply)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaHowToSupply {
  // Private constructor prevents instantiation
  const SchemaHowToSupply._();

  /// IRI term for the HowToSupply class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/HowToSupply');
  ...
  /// requiredQuantity [Expects: https://schema.org/Number, https://schema.org/QuantitativeValue, https://schema.org/Text]
  ///
