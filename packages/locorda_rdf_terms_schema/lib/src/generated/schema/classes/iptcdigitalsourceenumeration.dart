...
/// IPTCDigitalSourceEnumeration class from Schema vocabulary
///
...
/// - MediaEnumeration (https://schema.org/MediaEnumeration)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with IPTCDigitalSourceEnumeration.
/// [Class Reference](https://schema.org/IPTCDigitalSourceEnumeration)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaIPTCDigitalSourceEnumeration {
  // Private constructor prevents instantiation
  const SchemaIPTCDigitalSourceEnumeration._();

  /// IRI term for the IPTCDigitalSourceEnumeration class
