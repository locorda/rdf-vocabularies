...
/// Ligament class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with Ligament.
/// [Class Reference](https://schema.org/Ligament)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaLigament {
  // Private constructor prevents instantiation
  const SchemaLigament._();

  /// IRI term for the Ligament class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('https://schema.org/Ligament');
