...
/// MedicalConditionStage class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with MedicalConditionStage.
/// [Class Reference](https://schema.org/MedicalConditionStage)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaMedicalConditionStage {
  // Private constructor prevents instantiation
  const SchemaMedicalConditionStage._();

  /// IRI term for the MedicalConditionStage class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/MedicalConditionStage');
  ...
  /// stageAsNumber [Expects: https://schema.org/Number]
  ///
  ...
  /// subStageSuffix [Expects: https://schema.org/Text]
  ///
