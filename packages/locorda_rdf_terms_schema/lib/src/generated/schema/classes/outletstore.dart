...
/// OutletStore class from Schema vocabulary
///
/// An outlet store.
///
/// Inherits from:
...
///
/// This class provides access to all properties that can be used with OutletStore.
/// [Class Reference](https://schema.org/OutletStore)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaOutletStore {
  // Private constructor prevents instantiation
  const SchemaOutletStore._();

  /// IRI term for the OutletStore class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/OutletStore');
