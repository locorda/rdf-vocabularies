...
/// PetStore class from Schema vocabulary
///
/// A pet store.
///
/// Inherits from:
...
///
/// This class provides access to all properties that can be used with PetStore.
/// [Class Reference](https://schema.org/PetStore)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaPetStore {
  // Private constructor prevents instantiation
  const SchemaPetStore._();

  /// IRI term for the PetStore class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/PetStore');
