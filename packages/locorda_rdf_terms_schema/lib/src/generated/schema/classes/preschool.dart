...
/// Preschool class from Schema vocabulary
///
/// A preschool.
///
/// Inherits from:
...
///
/// This class provides access to all properties that can be used with Preschool.
/// [Class Reference](https://schema.org/Preschool)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaPreschool {
  // Private constructor prevents instantiation
  const SchemaPreschool._();

  /// IRI term for the Preschool class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('https://schema.org/Preschool');
