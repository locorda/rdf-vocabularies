...
/// RentAction class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with RentAction.
/// [Class Reference](https://schema.org/RentAction)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaRentAction {
  // Private constructor prevents instantiation
  const SchemaRentAction._();

  /// IRI term for the RentAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/RentAction');
  ...
  /// landlord [Expects: https://schema.org/Organization, https://schema.org/Person]
  ///
