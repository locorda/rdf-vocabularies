...
/// Reservoir class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with Reservoir.
/// [Class Reference](https://schema.org/Reservoir)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaReservoir {
  // Private constructor prevents instantiation
  const SchemaReservoir._();

  /// IRI term for the Reservoir class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('https://schema.org/Reservoir');
