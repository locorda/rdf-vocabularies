...
/// ResetPasswordAction class from Schema vocabulary
///
/// The action of resetting the password of a device or application.
///
/// Inherits from:
/// - Action (https://schema.org/Action)
/// - ControlAction (https://schema.org/ControlAction)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with ResetPasswordAction.
/// [Class Reference](https://schema.org/ResetPasswordAction)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaResetPasswordAction {
  // Private constructor prevents instantiation
  const SchemaResetPasswordAction._();

  /// IRI term for the ResetPasswordAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/ResetPasswordAction');
