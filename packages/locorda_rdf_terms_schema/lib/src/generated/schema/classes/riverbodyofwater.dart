...
/// RiverBodyOfWater class from Schema vocabulary
///
/// A river (for example, the broad majestic Shannon).
///
/// Inherits from:
/// - BodyOfWater (https://schema.org/BodyOfWater)
/// - Landform (https://schema.org/Landform)
/// - Place (https://schema.org/Place)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with RiverBodyOfWater.
/// [Class Reference](https://schema.org/RiverBodyOfWater)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaRiverBodyOfWater {
  // Private constructor prevents instantiation
  const SchemaRiverBodyOfWater._();

  /// IRI term for the RiverBodyOfWater class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('https://schema.org/RiverBodyOfWater');
