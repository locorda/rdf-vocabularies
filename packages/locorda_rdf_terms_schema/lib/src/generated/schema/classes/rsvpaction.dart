...
/// RsvpAction class from Schema vocabulary
///
...
/// - InformAction (https://schema.org/InformAction)
/// - InteractAction (https://schema.org/InteractAction)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with RsvpAction.
/// [Class Reference](https://schema.org/RsvpAction)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaRsvpAction {
  // Private constructor prevents instantiation
  const SchemaRsvpAction._();

  /// IRI term for the RsvpAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/RsvpAction');
  ...
  /// additionalNumberOfGuests [Expects: https://schema.org/Number]
  ///
