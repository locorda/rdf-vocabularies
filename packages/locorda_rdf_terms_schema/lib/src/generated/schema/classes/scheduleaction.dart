...
/// ScheduleAction class from Schema vocabulary
///
...
/// - PlanAction (https://schema.org/PlanAction)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with ScheduleAction.
/// [Class Reference](https://schema.org/ScheduleAction)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaScheduleAction {
  // Private constructor prevents instantiation
  const SchemaScheduleAction._();

  /// IRI term for the ScheduleAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/ScheduleAction');
  ...
  /// scheduledTime [Expects: https://schema.org/Date, https://schema.org/DateTime]
  ///
