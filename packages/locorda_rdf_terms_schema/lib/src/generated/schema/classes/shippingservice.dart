...
/// ShippingService class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with ShippingService.
/// [Class Reference](https://schema.org/ShippingService)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaShippingService {
  // Private constructor prevents instantiation
  const SchemaShippingService._();

  /// IRI term for the ShippingService class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/ShippingService');
  ...
  /// shippingConditions [Expects: https://schema.org/ShippingConditions]
  ///
