...
/// SkiResort class from Schema vocabulary
///
/// A ski resort.
///
/// Inherits from:
...
/// - SportsActivityLocation (https://schema.org/SportsActivityLocation)
/// - Thing (https://schema.org/Thing)
/// - Thing (http://www.w3.org/2002/07/owl#Thing)
///
/// This class provides access to all properties that can be used with SkiResort.
/// [Class Reference](https://schema.org/SkiResort)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaSkiResort {
  // Private constructor prevents instantiation
  const SchemaSkiResort._();

  /// IRI term for the SkiResort class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/SkiResort');
