...
/// USNonprofitType class from Schema vocabulary
///
...
/// - NonprofitType (https://schema.org/NonprofitType)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with USNonprofitType.
/// [Class Reference](https://schema.org/USNonprofitType)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaUSNonprofitType {
  // Private constructor prevents instantiation
  const SchemaUSNonprofitType._();

  /// IRI term for the USNonprofitType class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/USNonprofitType');
