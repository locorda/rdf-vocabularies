...
/// Waterfall class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with Waterfall.
/// [Class Reference](https://schema.org/Waterfall)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaWaterfall {
  // Private constructor prevents instantiation
  const SchemaWaterfall._();

  /// IRI term for the Waterfall class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('https://schema.org/Waterfall');
