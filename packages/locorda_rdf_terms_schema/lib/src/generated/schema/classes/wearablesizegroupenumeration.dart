...
/// WearableSizeGroupEnumeration class from Schema vocabulary
///
...
/// - SizeGroupEnumeration (https://schema.org/SizeGroupEnumeration)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with WearableSizeGroupEnumeration.
/// [Class Reference](https://schema.org/WearableSizeGroupEnumeration)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaWearableSizeGroupEnumeration {
  // Private constructor prevents instantiation
  const SchemaWearableSizeGroupEnumeration._();

  /// IRI term for the WearableSizeGroupEnumeration class
