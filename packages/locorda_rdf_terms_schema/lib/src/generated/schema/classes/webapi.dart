...
/// WebAPI class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with WebAPI.
/// [Class Reference](https://schema.org/WebAPI)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaWebAPI {
  // Private constructor prevents instantiation
  const SchemaWebAPI._();

  /// IRI term for the WebAPI class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/WebAPI');
  ...
  /// documentation [Expects: https://schema.org/CreativeWork, https://schema.org/URL]
  ///
