...
/// AdultEntertainment class from Schema vocabulary
///
/// An adult entertainment establishment.
///
/// Inherits from:
/// - EntertainmentBusiness (https://schema.org/EntertainmentBusiness)
...
///
/// This class provides access to all properties that can be used with AdultEntertainment.
/// [Class Reference](https://schema.org/AdultEntertainment)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaAdultEntertainment {
  // Private constructor prevents instantiation
  const SchemaAdultEntertainment._();

  /// IRI term for the AdultEntertainment class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/AdultEntertainment');
