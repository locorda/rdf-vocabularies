...
/// Airline class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with Airline.
/// [Class Reference](https://schema.org/Airline)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaAirline {
  // Private constructor prevents instantiation
  const SchemaAirline._();

  /// IRI term for the Airline class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/Airline');
  ...
  /// iataCode [Expects: https://schema.org/Text]
  ///
