...
/// AMRadioChannel class from Schema vocabulary
///
...
/// - RadioChannel (https://schema.org/RadioChannel)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with AMRadioChannel.
/// [Class Reference](https://schema.org/AMRadioChannel)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaAMRadioChannel {
  // Private constructor prevents instantiation
  const SchemaAMRadioChannel._();

  /// IRI term for the AMRadioChannel class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/AMRadioChannel');
