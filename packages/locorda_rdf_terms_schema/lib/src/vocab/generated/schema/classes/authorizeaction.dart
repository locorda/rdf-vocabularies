...
/// AuthorizeAction class from Schema vocabulary
///
/// The act of granting permission to an object.
///
/// Inherits from:
/// - Action (https://schema.org/Action)
/// - AllocateAction (https://schema.org/AllocateAction)
/// - OrganizeAction (https://schema.org/OrganizeAction)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with AuthorizeAction.
/// [Class Reference](https://schema.org/AuthorizeAction)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaAuthorizeAction {
  // Private constructor prevents instantiation
  const SchemaAuthorizeAction._();

  /// IRI term for the AuthorizeAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/AuthorizeAction');
