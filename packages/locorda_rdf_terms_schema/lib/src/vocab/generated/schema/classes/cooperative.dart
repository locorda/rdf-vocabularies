...
/// Cooperative class from Schema vocabulary
///
...
///
/// Equivalent to:
/// - CooperativeSociety (https://spec.edmcouncil.org/fibo/ontology/BE/LegalEntities/CorporateBodies/CooperativeSociety)
...
/// - Organization (https://gs1.org/voc/Organization)
/// - Organization (https://www.gs1.org/voc/Organization)
///
/// This class provides access to all properties that can be used with Cooperative.
/// [Class Reference](https://schema.org/Cooperative)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaCooperative {
  // Private constructor prevents instantiation
  const SchemaCooperative._();

  /// IRI term for the Cooperative class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/Cooperative');
  ...
  /// additionalOrganizationID from gs1 vocabulary [Expects: https://ref.gs1.org/voc/OrganizationID_Details]
  ///
  ...
  ///
  static const gs1AdditionalOrganizationID = IriTerm(
    'https://ref.gs1.org/voc/additionalOrganizationID',
  );

  /// additionalOrganizationIdentificationTypeValue from gs1 vocabulary [Expects: http://www.w3.org/2001/XMLSchema#string]
  ///
  /// The value associated with the Additional Organization Identification Type Value.
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1AdditionalOrganizationIdentificationTypeValue = IriTerm(
    'https://ref.gs1.org/voc/additionalOrganizationIdentificationTypeValue',
  );

  /// affiliatedTo from gs1 vocabulary [Expects: https://ref.gs1.org/voc/Organization]
  ///
  ...
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1AffiliatedTo = IriTerm(
    'https://ref.gs1.org/voc/affiliatedTo',
  );
  ...
  /// companyFilingURL from gs1 vocabulary [Expects: http://www.w3.org/2001/XMLSchema#anyURI]
  ///
  /// A URI value linking to information related to organisation filing details.
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1CompanyFilingURL = IriTerm(
    'https://ref.gs1.org/voc/companyFilingURL',
  );
  ...
  /// csrAffiliation from gs1 vocabulary [Expects: http://www.w3.org/2001/XMLSchema#anyURI]
  ///
  ...
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1CsrAffiliation = IriTerm(
    'https://ref.gs1.org/voc/csrAffiliation',
  );
  ...
  /// department from gs1 vocabulary [Expects: http://www.w3.org/1999/02/22-rdf-syntax-ns#langString]
  ///
  /// The name of a division of an organization dealing with a specific activity
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1Department = IriTerm('https://ref.gs1.org/voc/department');
  ...
  /// franchiseeOf from gs1 vocabulary [Expects: https://ref.gs1.org/voc/Organization]
  ///
  /// Method for associating the franchisor organisation to the franchisee.
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1FranchiseeOf = IriTerm(
    'https://ref.gs1.org/voc/franchiseeOf',
  );

  /// franchisorOf from gs1 vocabulary [Expects: https://ref.gs1.org/voc/Organization]
  ///
  /// Method for associating franchisee organisation(s) to the franchisor.
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1FranchisorOf = IriTerm(
    'https://ref.gs1.org/voc/franchisorOf',
  );
  ...
  /// hasPrimaryLocation from gs1 vocabulary [Expects: https://ref.gs1.org/voc/Place]
  ///
  /// Links to the place(s) that this organisation designates as their primary location(s).
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1HasPrimaryLocation = IriTerm(
    'https://ref.gs1.org/voc/hasPrimaryLocation',
  );
  ...
  /// lesseeOf from gs1 vocabulary [Expects: https://ref.gs1.org/voc/Place]
  ///
  ...
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1LesseeOf = IriTerm('https://ref.gs1.org/voc/lesseeOf');

  /// lessorFor from gs1 vocabulary [Expects: https://ref.gs1.org/voc/Place]
  ///
  /// Links to the place(s) for which this organisation is the lessor (i.e., this organisation leases those places to others).
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1LessorFor = IriTerm('https://ref.gs1.org/voc/lessorFor');
  ...
  /// location from gs1 vocabulary [Expects: https://ref.gs1.org/voc/Place]
  ///
  /// The place(s) associated with an organization.
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1Location = IriTerm('https://ref.gs1.org/voc/location');
  ...
  /// makesOffer from gs1 vocabulary [Expects: https://ref.gs1.org/voc/Offer]
  ///
  /// An offer made by an organization.
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1MakesOffer = IriTerm('https://ref.gs1.org/voc/makesOffer');

  /// manages from gs1 vocabulary
  ///
  /// Links to the place(s) or organisation(s) that this organisation manages, on behalf of the owner or another organisation.
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1Manages = IriTerm('https://ref.gs1.org/voc/manages');
  ...
  /// occupies from gs1 vocabulary [Expects: https://ref.gs1.org/voc/Place]
  ///
  /// Links to the place(s) that this organisation occupies.
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1Occupies = IriTerm('https://ref.gs1.org/voc/occupies');
  ...
  /// organizationHistory from gs1 vocabulary [Expects: https://ref.gs1.org/voc/OrganizationStatusHistory]
  ///
  /// Provides details on if and when an organisation/party is active or inactive.
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1OrganizationHistory = IriTerm(
    'https://ref.gs1.org/voc/organizationHistory',
  );
  ...
  /// owns from gs1 vocabulary
  ///
  /// Links to the place(s) or organisation(s) that this organisation owns.
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1Owns = IriTerm('https://ref.gs1.org/voc/owns');
  ...
  /// partyGLN from gs1 vocabulary [Expects: http://www.w3.org/2001/XMLSchema#string]
  ///
  ...
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1PartyGLN = IriTerm('https://ref.gs1.org/voc/partyGLN');
  ...
  /// replacedByOrganization from gs1 vocabulary [Expects: https://ref.gs1.org/voc/Organization]
  ///
  /// Links to the successor organisation that is used in place of a previous organisation
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1ReplacedByOrganization = IriTerm(
    'https://ref.gs1.org/voc/replacedByOrganization',
  );

  /// replacedOrganization from gs1 vocabulary [Expects: https://ref.gs1.org/voc/Organization]
  ///
  /// Links to the previous organisation that this organisation replaces
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1ReplacedOrganization = IriTerm(
    'https://ref.gs1.org/voc/replacedOrganization',
  );
  ...
  /// responsibleForLocation from gs1 vocabulary [Expects: https://ref.gs1.org/voc/Place]
  ///
  /// Links to the place(s) for which this organisation is responsible.
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1ResponsibleForLocation = IriTerm(
    'https://ref.gs1.org/voc/responsibleForLocation',
  );
  ...
  /// usesManagedLocation from gs1 vocabulary [Expects: https://ref.gs1.org/voc/Place]
  ///
  /// Links to the place(s) that this organisation uses as a managed space.
  ///
  /// Can be used on: https://ref.gs1.org/voc/Organization
  ///
  static const gs1UsesManagedLocation = IriTerm(
    'https://ref.gs1.org/voc/usesManagedLocation',
  );
