...
/// EnergyStarEnergyEfficiencyEnumeration class from Schema vocabulary
///
/// Used to indicate whether a product is EnergyStar certified.
///
/// Inherits from:
/// - EnergyEfficiencyEnumeration (https://schema.org/EnergyEfficiencyEnumeration)
/// - Enumeration (https://schema.org/Enumeration)
/// - Intangible (https://schema.org/Intangible)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with EnergyStarEnergyEfficiencyEnumeration.
/// [Class Reference](https://schema.org/EnergyStarEnergyEfficiencyEnumeration)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaEnergyStarEnergyEfficiencyEnumeration {
  // Private constructor prevents instantiation
  const SchemaEnergyStarEnergyEfficiencyEnumeration._();

  /// IRI term for the EnergyStarEnergyEfficiencyEnumeration class
