...
/// Error class from Schema vocabulary
///
/// Representation of an Error.
///
/// Inherits from:
/// - InstantaneousEvent (https://schema.org/InstantaneousEvent)
/// - Intangible (https://schema.org/Intangible)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Resource (http://www.w3.org/ns/hydra/core#Resource)
/// - Result (http://sarif.info/Result)
/// - Status (http://www.w3.org/ns/hydra/core#Status)
/// - StructuredValue (https://schema.org/StructuredValue)
/// - Thing (http://www.w3.org/2002/07/owl#Thing)
/// - Thing (https://schema.org/Thing)
///
/// Equivalent to:
/// - Error (http://www.w3.org/ns/hydra/core#Error)
/// - InstantaneousEvent (http://www.w3.org/ns/prov#InstantaneousEvent)
///
/// This class provides access to all properties that can be used with Error.
/// [Class Reference](https://schema.org/Error)
///
...
class SchemaError {
  ...
  /// IRI term for the Error class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/Error');
  ...
  /// data [Expects: https://schema.org/Thing]
  ///
  ...
  /// errorCode [Expects: https://schema.org/DefinedTerm, https://schema.org/Integer, https://schema.org/StatusEnumeration, https://schema.org/Text]
  ///
  ...
  /// source [Expects: https://schema.org/Thing]
  ///
  ...
  /// timestamp [Expects: https://schema.org/DateTime]
  ///
  ...
  /// atTime from prov vocabulary [Expects: http://www.w3.org/2001/XMLSchema#dateTime]
  ///
  /// The time at which an InstantaneousEvent occurred, in the form of xsd:dateTime.
  ///
  /// Can be used on: http://www.w3.org/ns/prov#InstantaneousEvent
  ///
  static const provAtTime = IriTerm('http://www.w3.org/ns/prov#atTime');

  /// statusCode from hydra vocabulary [Expects: http://www.w3.org/2001/XMLSchema#integer]
  ///
  /// The HTTP status code
  ///
  /// Can be used on: http://www.w3.org/ns/hydra/core#Status
  ///
  static const hydraStatusCode = IriTerm(
