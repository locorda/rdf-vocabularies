...
/// Joint class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with Joint.
/// [Class Reference](https://schema.org/Joint)
///
...
class SchemaJoint {
  ...
  static const classIri = IriTerm('https://schema.org/Joint');
  ...
  /// biomechnicalClass [Expects: https://schema.org/Text]
  ///
  ...
  /// functionalClass [Expects: https://schema.org/MedicalEntity, https://schema.org/Text]
  ///
  ...
  /// structuralClass [Expects: https://schema.org/Text]
  ///
