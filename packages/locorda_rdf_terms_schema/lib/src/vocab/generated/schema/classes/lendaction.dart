...
/// LendAction class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with LendAction.
/// [Class Reference](https://schema.org/LendAction)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaLendAction {
  // Private constructor prevents instantiation
  const SchemaLendAction._();

  /// IRI term for the LendAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/LendAction');
  ...
  /// borrower [Expects: https://schema.org/Person]
  ///
