...
/// LinkRole class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with LinkRole.
/// [Class Reference](https://schema.org/LinkRole)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaLinkRole {
  // Private constructor prevents instantiation
  const SchemaLinkRole._();

  /// IRI term for the LinkRole class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/LinkRole');
  ...
  /// linkRelationship [Expects: https://schema.org/Text]
  ///
