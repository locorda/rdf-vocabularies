...
/// MusicStore class from Schema vocabulary
///
/// A music store.
///
/// Inherits from:
...
///
/// This class provides access to all properties that can be used with MusicStore.
/// [Class Reference](https://schema.org/MusicStore)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaMusicStore {
  // Private constructor prevents instantiation
  const SchemaMusicStore._();

  /// IRI term for the MusicStore class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/MusicStore');
