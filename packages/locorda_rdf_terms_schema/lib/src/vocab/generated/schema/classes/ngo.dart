...
/// NGO class from Schema vocabulary
///
...
///
/// Equivalent to:
/// - NonGovernmentalOrganization (https://spec.edmcouncil.org/fibo/ontology/BE/NotForProfitOrganizations/NotForProfitOrganizations/NonGovernmentalOrganization)
...
///
/// This class provides access to all properties that can be used with NGO.
/// [Class Reference](https://schema.org/NGO)
///
...
class SchemaNGO {
  ...
  /// IRI term for the NGO class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/NGO');
