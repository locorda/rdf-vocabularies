...
/// Oncologic class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with Oncologic.
/// [Class Reference](https://schema.org/Oncologic)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaOncologic {
  // Private constructor prevents instantiation
  const SchemaOncologic._();

  /// IRI term for the Oncologic class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/Oncologic');
