...
/// PaymentService class from Schema vocabulary
///
...
/// - PaymentService (https://spec.edmcouncil.org/fibo/ontology/PAY/PaymentServices/PaymentServices/PaymentService)
///
/// This class provides access to all properties that can be used with PaymentService.
/// [Class Reference](https://schema.org/PaymentService)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaPaymentService {
  // Private constructor prevents instantiation
  const SchemaPaymentService._();

  /// IRI term for the PaymentService class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/PaymentService');
