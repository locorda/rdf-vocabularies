...
/// PlayGameAction class from Schema vocabulary
///
/// The act of playing a video game.
///
/// Inherits from:
/// - Action (https://schema.org/Action)
/// - ConsumeAction (https://schema.org/ConsumeAction)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with PlayGameAction.
/// [Class Reference](https://schema.org/PlayGameAction)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaPlayGameAction {
  // Private constructor prevents instantiation
  const SchemaPlayGameAction._();

  /// IRI term for the PlayGameAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/PlayGameAction');

  /// actionAccessibilityRequirement [Expects: https://schema.org/ActionAccessSpecification]
  ///
  ...
  /// gameAvailabilityType [Expects: https://schema.org/GameAvailabilityEnumeration, https://schema.org/Text]
  ///
