...
/// PostOffice class from Schema vocabulary
///
/// A post office.
///
/// Inherits from:
/// - GovernmentOffice (https://schema.org/GovernmentOffice)
...
///
/// This class provides access to all properties that can be used with PostOffice.
/// [Class Reference](https://schema.org/PostOffice)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaPostOffice {
  // Private constructor prevents instantiation
  const SchemaPostOffice._();

  /// IRI term for the PostOffice class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/PostOffice');
