...
/// SportsTeam class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with SportsTeam.
/// [Class Reference](https://schema.org/SportsTeam)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaSportsTeam {
  // Private constructor prevents instantiation
  const SchemaSportsTeam._();

  /// IRI term for the SportsTeam class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/SportsTeam');
  ...
  /// athlete [Expects: https://schema.org/Person]
  ///
  ...
  /// coach [Expects: https://schema.org/Person]
  ///
