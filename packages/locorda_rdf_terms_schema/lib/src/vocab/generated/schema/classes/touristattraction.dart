...
/// TouristAttraction class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with TouristAttraction.
/// [Class Reference](https://schema.org/TouristAttraction)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaTouristAttraction {
  // Private constructor prevents instantiation
  const SchemaTouristAttraction._();

  /// IRI term for the TouristAttraction class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/TouristAttraction');
