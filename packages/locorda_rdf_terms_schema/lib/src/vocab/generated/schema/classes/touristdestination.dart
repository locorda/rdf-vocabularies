...
/// TouristDestination class from Schema vocabulary
///
...
///
/// This class provides access to all properties that can be used with TouristDestination.
/// [Class Reference](https://schema.org/TouristDestination)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaTouristDestination {
  // Private constructor prevents instantiation
  const SchemaTouristDestination._();

  /// IRI term for the TouristDestination class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/TouristDestination');
  ...
  /// includesAttraction [Expects: https://schema.org/TouristAttraction]
  ///
  ...
  /// touristType [Expects: https://schema.org/Audience, https://schema.org/Text]
  ///
