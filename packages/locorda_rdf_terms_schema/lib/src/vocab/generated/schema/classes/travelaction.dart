...
/// TravelAction class from Schema vocabulary
///
/// The act of traveling from a fromLocation to a destination by a specified mode of transport, optionally with participants.
///
/// Inherits from:
/// - Action (https://schema.org/Action)
/// - MoveAction (https://schema.org/MoveAction)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with TravelAction.
/// [Class Reference](https://schema.org/TravelAction)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaTravelAction {
  // Private constructor prevents instantiation
  const SchemaTravelAction._();

  /// IRI term for the TravelAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/TravelAction');
