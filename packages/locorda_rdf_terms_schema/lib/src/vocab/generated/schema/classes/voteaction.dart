...
/// VoteAction class from Schema vocabulary
///
/// The act of expressing a preference from a fixed/finite/structured set of choices/options.
///
/// Inherits from:
/// - Action (https://schema.org/Action)
/// - AssessAction (https://schema.org/AssessAction)
/// - ChooseAction (https://schema.org/ChooseAction)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with VoteAction.
/// [Class Reference](https://schema.org/VoteAction)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaVoteAction {
  // Private constructor prevents instantiation
  const SchemaVoteAction._();

  /// IRI term for the VoteAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/VoteAction');
  ...
  /// candidate [Expects: https://schema.org/Person]
  ///
  ...
  /// option [Expects: https://schema.org/Text, https://schema.org/Thing]
  ///
  ...
  /// actionOption [Expects: https://schema.org/Text, https://schema.org/Thing]
  ///
  /// A sub property of object. The options subject to this action.
  ///
  /// Can be used on: https://schema.org/ChooseAction
