...
/// WearableMeasurementTypeEnumeration class from Schema vocabulary
///
...
/// - MeasurementTypeEnumeration (https://schema.org/MeasurementTypeEnumeration)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with WearableMeasurementTypeEnumeration.
/// [Class Reference](https://schema.org/WearableMeasurementTypeEnumeration)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaWearableMeasurementTypeEnumeration {
  // Private constructor prevents instantiation
  const SchemaWearableMeasurementTypeEnumeration._();
