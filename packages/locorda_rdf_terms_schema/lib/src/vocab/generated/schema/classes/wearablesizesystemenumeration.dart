...
/// WearableSizeSystemEnumeration class from Schema vocabulary
///
...
/// - SizeSystemEnumeration (https://schema.org/SizeSystemEnumeration)
/// - Thing (https://schema.org/Thing)
///
/// This class provides access to all properties that can be used with WearableSizeSystemEnumeration.
/// [Class Reference](https://schema.org/WearableSizeSystemEnumeration)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaWearableSizeSystemEnumeration {
  // Private constructor prevents instantiation
  const SchemaWearableSizeSystemEnumeration._();

  /// IRI term for the WearableSizeSystemEnumeration class
