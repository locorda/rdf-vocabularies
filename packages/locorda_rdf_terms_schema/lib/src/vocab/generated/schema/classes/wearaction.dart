...
/// WearAction class from Schema vocabulary
///
...
/// - UseAction (https://schema.org/UseAction)
///
/// This class provides access to all properties that can be used with WearAction.
/// [Class Reference](https://schema.org/WearAction)
///
/// [Vocabulary Reference](https://schema.org/)
class SchemaWearAction {
  // Private constructor prevents instantiation
  const SchemaWearAction._();

  /// IRI term for the WearAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('https://schema.org/WearAction');
