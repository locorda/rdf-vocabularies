...
/// Airport class from SchemaHttp vocabulary
///
/// An airport.
///
/// Inherits from:
...
///
/// This class provides access to all properties that can be used with Airport.
/// [Class Reference](http://schema.org/Airport)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpAirport {
  // Private constructor prevents instantiation
  const SchemaHttpAirport._();

  /// IRI term for the Airport class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/Airport');
  ...
  /// icaoCode [Expects: http://schema.org/Text]
  ///
  /// ICAO identifier for an airport.
  ///
  /// Can be used on: http://schema.org/Airport
  ///
  static const icaoCode = const IriTerm('http://schema.org/icaoCode');
