...
/// Aquarium class from SchemaHttp vocabulary
///
/// Aquarium.
///
/// Inherits from:
...
///
/// This class provides access to all properties that can be used with Aquarium.
/// [Class Reference](http://schema.org/Aquarium)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpAquarium {
  // Private constructor prevents instantiation
  const SchemaHttpAquarium._();

  /// IRI term for the Aquarium class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/Aquarium');
