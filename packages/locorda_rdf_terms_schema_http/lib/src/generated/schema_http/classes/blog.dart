...
/// Blog class from SchemaHttp vocabulary
///
...
///
/// This class provides access to all properties that can be used with Blog.
/// [Class Reference](http://schema.org/Blog)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpBlog {
  // Private constructor prevents instantiation
  const SchemaHttpBlog._();

  /// IRI term for the Blog class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('http://schema.org/Blog');
  ...
  /// blogPosts [Expects: http://schema.org/BlogPosting]
  ///
  ...
  /// blogPost [Expects: http://schema.org/BlogPosting]
  ///
