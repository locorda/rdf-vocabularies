...
/// BoatTerminal class from SchemaHttp vocabulary
///
...
///
/// This class provides access to all properties that can be used with BoatTerminal.
/// [Class Reference](http://schema.org/BoatTerminal)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpBoatTerminal {
  // Private constructor prevents instantiation
  const SchemaHttpBoatTerminal._();

  /// IRI term for the BoatTerminal class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/BoatTerminal');
