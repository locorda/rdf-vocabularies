...
/// BorrowAction class from SchemaHttp vocabulary
///
...
/// [Class Reference](http://schema.org/BorrowAction)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpBorrowAction {
  // Private constructor prevents instantiation
  const SchemaHttpBorrowAction._();

  /// IRI term for the BorrowAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/BorrowAction');
  ...
  /// lender [Expects: http://schema.org/Organization, http://schema.org/Person]
  ///
  /// A sub property of participant. The person that lends the object being borrowed.
  ///
  /// Can be used on: http://schema.org/BorrowAction
  ///
  static const lender = const IriTerm('http://schema.org/lender');
