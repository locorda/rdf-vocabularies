...
/// Brand class from SchemaHttp vocabulary
///
...
///
/// Equivalent to:
/// - BrandName (http://unece.org/vocab#BrandName)
///
/// This class provides access to all properties that can be used with Brand.
/// [Class Reference](http://schema.org/Brand)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpBrand {
  // Private constructor prevents instantiation
  const SchemaHttpBrand._();

  /// IRI term for the Brand class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('http://schema.org/Brand');
