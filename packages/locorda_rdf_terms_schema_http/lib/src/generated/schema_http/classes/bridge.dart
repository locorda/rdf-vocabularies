...
/// Bridge class from SchemaHttp vocabulary
///
/// A bridge.
///
/// Inherits from:
...
///
/// This class provides access to all properties that can be used with Bridge.
/// [Class Reference](http://schema.org/Bridge)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpBridge {
  // Private constructor prevents instantiation
  const SchemaHttpBridge._();

  /// IRI term for the Bridge class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/Bridge');
