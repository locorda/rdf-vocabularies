...
/// Claim class from SchemaHttp vocabulary
///
...
///
/// This class provides access to all properties that can be used with Claim.
/// [Class Reference](http://schema.org/Claim)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpClaim {
  // Private constructor prevents instantiation
  const SchemaHttpClaim._();

  /// IRI term for the Claim class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('http://schema.org/Claim');
  ...
  /// appearance [Expects: http://schema.org/CreativeWork]
  ///
