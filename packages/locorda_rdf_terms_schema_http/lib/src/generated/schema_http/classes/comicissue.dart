...
/// ComicIssue class from SchemaHttp vocabulary
///
...
///
/// Inherits from:
/// - CollectedDocument (http://purl.org/ontology/bibo/CollectedDocument)
...
///
/// This class provides access to all properties that can be used with ComicIssue.
/// [Class Reference](http://schema.org/ComicIssue)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpComicIssue {
  // Private constructor prevents instantiation
  const SchemaHttpComicIssue._();

  /// IRI term for the ComicIssue class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/ComicIssue');
  ...
  ///
  static const artist = const IriTerm('http://schema.org/artist');
  ...
  /// Can be used on: http://schema.org/ComicIssue, http://schema.org/ComicStory, http://schema.org/VisualArtwork
  ///
  static const colorist = const IriTerm('http://schema.org/colorist');
  ...
  /// Can be used on: http://schema.org/ComicIssue, http://schema.org/ComicStory, http://schema.org/VisualArtwork
  ///
  static const inker = const IriTerm('http://schema.org/inker');
  ...
  /// issueNumber [Expects: http://schema.org/Integer, http://schema.org/Text]
  ///
  /// Identifies the issue of publication; for example, "iii" or "2".
  ///
  /// Can be used on: http://schema.org/PublicationIssue
  ///
  static const issueNumber = const IriTerm('http://schema.org/issueNumber');
  ...
  /// Can be used on: http://schema.org/ComicIssue, http://schema.org/ComicStory, http://schema.org/VisualArtwork
  ///
  static const letterer = const IriTerm('http://schema.org/letterer');
  ...
  /// Can be used on: http://schema.org/ComicIssue, http://schema.org/ComicStory, http://schema.org/VisualArtwork
  ///
  static const penciler = const IriTerm('http://schema.org/penciler');
  ...
  ///
  static const variantCover = const IriTerm('http://schema.org/variantCover');
