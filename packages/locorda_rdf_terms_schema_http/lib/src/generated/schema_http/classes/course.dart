...
/// Course class from SchemaHttp vocabulary
///
...
///
/// This class provides access to all properties that can be used with Course.
/// [Class Reference](http://schema.org/Course)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpCourse {
  // Private constructor prevents instantiation
  const SchemaHttpCourse._();

  /// IRI term for the Course class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('http://schema.org/Course');
  ...
  /// courseCode [Expects: http://schema.org/Text]
  ///
  ...
  /// hasCourseInstance [Expects: http://schema.org/CourseInstance]
  ///
  ...
  /// totalHistoricalEnrollment [Expects: http://schema.org/Integer]
  ///
