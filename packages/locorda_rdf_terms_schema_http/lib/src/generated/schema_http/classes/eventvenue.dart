...
/// EventVenue class from SchemaHttp vocabulary
///
/// An event venue.
///
/// Inherits from:
...
///
/// This class provides access to all properties that can be used with EventVenue.
/// [Class Reference](http://schema.org/EventVenue)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpEventVenue {
  // Private constructor prevents instantiation
  const SchemaHttpEventVenue._();

  /// IRI term for the EventVenue class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/EventVenue');
