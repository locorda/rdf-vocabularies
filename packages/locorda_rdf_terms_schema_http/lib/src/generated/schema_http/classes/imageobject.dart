...
/// ImageObject class from SchemaHttp vocabulary
///
/// An image file.
///
/// Inherits from:
...
///
/// This class provides access to all properties that can be used with ImageObject.
/// [Class Reference](http://schema.org/ImageObject)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpImageObject {
  // Private constructor prevents instantiation
  const SchemaHttpImageObject._();

  /// IRI term for the ImageObject class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('http://schema.org/ImageObject');
  ...
  /// exifData [Expects: http://schema.org/PropertyValue, http://schema.org/Text]
  ///
  ...
  /// representativeOfPage [Expects: http://schema.org/Boolean]
  ///
  ...
  ///
  static const foafDepicts = IriTerm('http://xmlns.com/foaf/0.1/depicts');

  /// thumbnail from foaf vocabulary [Expects: http://xmlns.com/foaf/0.1/Image]
  ///
  /// A derived thumbnail image.
  ///
  /// Can be used on: http://xmlns.com/foaf/0.1/Image
  ///
  static const foafThumbnail = IriTerm('http://xmlns.com/foaf/0.1/thumbnail');
