...
/// LendAction class from SchemaHttp vocabulary
///
...
/// [Class Reference](http://schema.org/LendAction)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpLendAction {
  // Private constructor prevents instantiation
  const SchemaHttpLendAction._();

  /// IRI term for the LendAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/LendAction');
  ...
  /// borrower [Expects: http://schema.org/Person]
  ///
  /// A sub property of participant. The person that borrows the object being lent.
  ///
  /// Can be used on: http://schema.org/LendAction
  ///
  static const borrower = const IriTerm('http://schema.org/borrower');
