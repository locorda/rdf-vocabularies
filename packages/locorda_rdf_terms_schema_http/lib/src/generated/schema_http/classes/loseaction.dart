...
/// LoseAction class from SchemaHttp vocabulary
///
...
/// [Class Reference](http://schema.org/LoseAction)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpLoseAction {
  // Private constructor prevents instantiation
  const SchemaHttpLoseAction._();

  /// IRI term for the LoseAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/LoseAction');
  ...
  /// winner [Expects: http://schema.org/Person]
  ///
  /// A sub property of participant. The winner of the action.
  ///
  /// Can be used on: http://schema.org/LoseAction
  ///
  static const winner = const IriTerm('http://schema.org/winner');
