...
/// Map class from SchemaHttp vocabulary
///
/// A map.
///
/// Inherits from:
...
///
/// This class provides access to all properties that can be used with Map.
/// [Class Reference](http://schema.org/Map)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpMap {
  // Private constructor prevents instantiation
  const SchemaHttpMap._();

  /// IRI term for the Map class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/Map');
  ...
  /// mapType [Expects: http://schema.org/MapCategoryType]
  ///
  /// Indicates the kind of Map, from the MapCategoryType Enumeration.
  ///
  /// Can be used on: http://schema.org/Map
  ///
  static const mapType = const IriTerm('http://schema.org/mapType');
