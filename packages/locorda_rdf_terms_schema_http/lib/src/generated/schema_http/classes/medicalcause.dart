...
/// MedicalCause class from SchemaHttp vocabulary
///
...
///
/// This class provides access to all properties that can be used with MedicalCause.
/// [Class Reference](http://schema.org/MedicalCause)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpMedicalCause {
  // Private constructor prevents instantiation
  const SchemaHttpMedicalCause._();

  /// IRI term for the MedicalCause class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/MedicalCause');
  ...
  /// causeOf [Expects: http://schema.org/MedicalEntity]
  ///
  /// The condition, complication, symptom, sign, etc. caused.
  ///
  /// Can be used on: http://schema.org/MedicalCause
  ///
  static const causeOf = const IriTerm('http://schema.org/causeOf');
