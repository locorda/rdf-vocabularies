...
/// MedicalRiskScore class from SchemaHttp vocabulary
///
...
///
/// This class provides access to all properties that can be used with MedicalRiskScore.
/// [Class Reference](http://schema.org/MedicalRiskScore)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpMedicalRiskScore {
  // Private constructor prevents instantiation
  const SchemaHttpMedicalRiskScore._();

  /// IRI term for the MedicalRiskScore class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('http://schema.org/MedicalRiskScore');
  ...
  /// algorithm [Expects: http://schema.org/Text]
  ///
  ...
  /// estimatesRiskOf [Expects: http://schema.org/MedicalEntity]
  ///
  ...
  /// includedRiskFactor [Expects: http://schema.org/MedicalRiskFactor]
  ///
