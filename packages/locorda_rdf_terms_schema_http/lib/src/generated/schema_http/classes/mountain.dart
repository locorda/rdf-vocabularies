...
/// Mountain class from SchemaHttp vocabulary
///
...
///
/// This class provides access to all properties that can be used with Mountain.
/// [Class Reference](http://schema.org/Mountain)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpMountain {
  // Private constructor prevents instantiation
  const SchemaHttpMountain._();

  /// IRI term for the Mountain class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/Mountain');
