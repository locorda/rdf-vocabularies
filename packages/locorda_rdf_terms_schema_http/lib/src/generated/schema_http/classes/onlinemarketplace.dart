...
/// OnlineMarketplace class from SchemaHttp vocabulary
///
...
///
/// This class provides access to all properties that can be used with OnlineMarketplace.
/// [Class Reference](http://schema.org/OnlineMarketplace)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpOnlineMarketplace {
  // Private constructor prevents instantiation
  const SchemaHttpOnlineMarketplace._();

  /// IRI term for the OnlineMarketplace class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/OnlineMarketplace');
  ...
  /// hasStore [Expects: http://schema.org/OnlineStore]
  ///
  /// An eCommerce store part of an online marketplace.
  ///
  /// Can be used on: http://schema.org/OnlineMarketplace
  ///
  static const hasStore = const IriTerm('http://schema.org/hasStore');
  ...
  /// isStoreOn [Expects: http://schema.org/OnlineMarketplace]
  ///
  /// The eCommerce marketplace this online store is on.
  ///
  /// Can be used on: http://schema.org/OnlineStore
  ///
  static const isStoreOn = const IriTerm('http://schema.org/isStoreOn');
