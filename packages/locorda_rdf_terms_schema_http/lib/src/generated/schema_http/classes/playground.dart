...
/// Playground class from SchemaHttp vocabulary
///
/// A playground.
///
/// Inherits from:
...
///
/// This class provides access to all properties that can be used with Playground.
/// [Class Reference](http://schema.org/Playground)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpPlayground {
  // Private constructor prevents instantiation
  const SchemaHttpPlayground._();

  /// IRI term for the Playground class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/Playground');
