...
/// PublicationVolume class from SchemaHttp vocabulary
///
...
///
/// This class provides access to all properties that can be used with PublicationVolume.
/// [Class Reference](http://schema.org/PublicationVolume)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpPublicationVolume {
  // Private constructor prevents instantiation
  const SchemaHttpPublicationVolume._();

  /// IRI term for the PublicationVolume class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/PublicationVolume');
  ...
  /// volumeNumber [Expects: http://schema.org/Integer, http://schema.org/Text]
  ///
  /// Identifies the volume of publication or multi-part work; for example, "iii" or "2".
  ///
  /// Can be used on: http://schema.org/PublicationVolume
  ///
  static const volumeNumber = const IriTerm('http://schema.org/volumeNumber');
