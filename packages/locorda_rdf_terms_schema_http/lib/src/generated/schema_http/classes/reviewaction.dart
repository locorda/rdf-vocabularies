...
/// ReviewAction class from SchemaHttp vocabulary
///
...
/// [Class Reference](http://schema.org/ReviewAction)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpReviewAction {
  // Private constructor prevents instantiation
  const SchemaHttpReviewAction._();

  /// IRI term for the ReviewAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/ReviewAction');
  ...
  /// resultReview [Expects: http://schema.org/Review]
  ///
  /// A sub property of result. The review that resulted in the performing of the action.
  ///
  /// Can be used on: http://schema.org/ReviewAction
  ///
  static const resultReview = const IriTerm('http://schema.org/resultReview');
