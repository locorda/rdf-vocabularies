...
/// SearchAction class from SchemaHttp vocabulary
///
...
/// [Class Reference](http://schema.org/SearchAction)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpSearchAction {
  // Private constructor prevents instantiation
  const SchemaHttpSearchAction._();

  /// IRI term for the SearchAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/SearchAction');
  ...
  /// query [Expects: http://schema.org/Text]
  ///
  /// A sub property of instrument. The query used on this action.
  ///
  /// Can be used on: http://schema.org/SearchAction
  ///
  static const query = const IriTerm('http://schema.org/query');
