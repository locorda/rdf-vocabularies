...
/// Seat class from SchemaHttp vocabulary
///
...
///
/// This class provides access to all properties that can be used with Seat.
/// [Class Reference](http://schema.org/Seat)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpSeat {
  // Private constructor prevents instantiation
  const SchemaHttpSeat._();

  /// IRI term for the Seat class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/Seat');
  ...
  /// seatNumber [Expects: http://schema.org/Text]
  ///
  /// The location of the reserved seat (e.g., 27).
  ///
  /// Can be used on: http://schema.org/Seat
  ///
  static const seatNumber = const IriTerm('http://schema.org/seatNumber');

  /// seatRow [Expects: http://schema.org/Text]
  ///
  /// The row location of the reserved seat (e.g., B).
  ///
  /// Can be used on: http://schema.org/Seat
  ///
  static const seatRow = const IriTerm('http://schema.org/seatRow');

  /// seatSection [Expects: http://schema.org/Text]
  ///
  /// The section location of the reserved seat (e.g. Orchestra).
  ///
  /// Can be used on: http://schema.org/Seat
  ///
  static const seatSection = const IriTerm('http://schema.org/seatSection');
  ...
  /// Can be used on: http://schema.org/Seat
  ///
  static const seatingType = const IriTerm('http://schema.org/seatingType');
