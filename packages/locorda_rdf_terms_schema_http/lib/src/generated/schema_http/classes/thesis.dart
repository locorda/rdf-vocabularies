...
/// Thesis class from SchemaHttp vocabulary
///
...
///
/// This class provides access to all properties that can be used with Thesis.
/// [Class Reference](http://schema.org/Thesis)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpThesis {
  // Private constructor prevents instantiation
  const SchemaHttpThesis._();

  /// IRI term for the Thesis class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/Thesis');
  ...
  /// inSupportOf [Expects: http://schema.org/Text]
  ///
  /// Qualification, candidature, degree, application that Thesis supports.
  ///
  /// Can be used on: http://schema.org/Thesis
  ///
  static const inSupportOf = const IriTerm('http://schema.org/inSupportOf');
