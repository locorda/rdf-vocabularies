...
/// Volcano class from SchemaHttp vocabulary
///
...
///
/// This class provides access to all properties that can be used with Volcano.
/// [Class Reference](http://schema.org/Volcano)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpVolcano {
  // Private constructor prevents instantiation
  const SchemaHttpVolcano._();

  /// IRI term for the Volcano class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/Volcano');
