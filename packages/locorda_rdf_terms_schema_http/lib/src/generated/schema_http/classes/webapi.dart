...
/// WebAPI class from SchemaHttp vocabulary
///
...
/// [Class Reference](http://schema.org/WebAPI)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpWebAPI {
  // Private constructor prevents instantiation
  const SchemaHttpWebAPI._();

  /// IRI term for the WebAPI class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/WebAPI');
  ...
  /// documentation [Expects: http://schema.org/CreativeWork, http://schema.org/URL]
  ///
  /// Further documentation describing the Web API in more detail.
  ///
  /// Can be used on: http://schema.org/WebAPI
  ///
  static const documentation = const IriTerm('http://schema.org/documentation');
