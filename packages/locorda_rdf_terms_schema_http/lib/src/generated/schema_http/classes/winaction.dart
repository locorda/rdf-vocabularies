...
/// WinAction class from SchemaHttp vocabulary
///
...
/// [Class Reference](http://schema.org/WinAction)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpWinAction {
  // Private constructor prevents instantiation
  const SchemaHttpWinAction._();

  /// IRI term for the WinAction class
  /// Use this to specify that a resource is of this type.
  static const classIri = const IriTerm('http://schema.org/WinAction');
  ...
  /// loser [Expects: http://schema.org/Person]
  ///
  /// A sub property of participant. The loser of the action.
  ///
  /// Can be used on: http://schema.org/WinAction
  ///
  static const loser = const IriTerm('http://schema.org/loser');
