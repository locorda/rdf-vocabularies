...
/// Certification class from SchemaHttp vocabulary
///
...
///
/// Inherits from:
/// - Certificate (https://spec.edmcouncil.org/fibo/ontology/FND/Arrangements/Documents/Certificate)
...
///
/// Equivalent to:
/// - CertificationDetails (https://ref.gs1.org/voc/CertificationDetails)
/// - CertificationDetails (https://gs1.org/voc/CertificationDetails)
/// - CertificationDetails (https://www.gs1.org/voc/CertificationDetails)
/// - Document (http://xmlns.com/foaf/0.1/Document)
/// - Document (http://purl.org/ontology/bibo/Document)
/// - SpecifiedCertificate (http://unece.org/vocab#SpecifiedCertificate)
///
/// This class provides access to all properties that can be used with Certification.
/// [Class Reference](http://schema.org/Certification)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpCertification {
  // Private constructor prevents instantiation
  const SchemaHttpCertification._();

  /// IRI term for the Certification class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('http://schema.org/Certification');
  ...
  /// auditDate [Expects: http://schema.org/Date, http://schema.org/DateTime]
  ///
  ...
  /// certificationIdentification [Expects: http://schema.org/DefinedTerm, http://schema.org/Text]
  ///
  ...
  /// certificationRating [Expects: http://schema.org/Rating]
  ///
  ...
  /// certificationStatus [Expects: http://schema.org/CertificationStatusEnumeration]
  ///
  ...
  /// certificationAgency from gs1 vocabulary [Expects: http://www.w3.org/1999/02/22-rdf-syntax-ns#langString]
  ///
  ...
  ///
  static const gs1CertificationAgency = IriTerm(
    'https://ref.gs1.org/voc/certificationAgency',
  );
  ...
  /// certificationAuditDate from gs1 vocabulary [Expects: http://www.w3.org/2001/XMLSchema#date]
  ///
  /// Date of completion of the auditing needed for certification
  ///
  /// Can be used on: https://ref.gs1.org/voc/CertificationDetails
  ///
  static const gs1CertificationAuditDate = IriTerm(
  ...
  /// certificationIdentification from gs1 vocabulary [Expects: http://www.w3.org/2001/XMLSchema#string]
  ///
  ...
  /// Can be used on: https://ref.gs1.org/voc/CertificationDetails
  ///
  static const gs1CertificationIdentification = IriTerm(
  ...
  /// certificationStandard from gs1 vocabulary [Expects: http://www.w3.org/1999/02/22-rdf-syntax-ns#langString]
  ///
  /// Name of the certification standard. Free text. Example: 'Egg classification' .
  ///
  /// Can be used on: https://ref.gs1.org/voc/CertificationDetails
  ///
  static const gs1CertificationStandard = IriTerm(
    'https://ref.gs1.org/voc/certificationStandard',
  );

  /// certificationStartDate from gs1 vocabulary [Expects: http://www.w3.org/2001/XMLSchema#date]
  ///
  /// First date of validity for the certification
  ///
  /// Can be used on: https://ref.gs1.org/voc/CertificationDetails
  ///
  static const gs1CertificationStartDate = IriTerm(
    'https://ref.gs1.org/voc/certificationStartDate',
  );

  /// certificationStatement from gs1 vocabulary [Expects: http://www.w3.org/1999/02/22-rdf-syntax-ns#langString]
  ///
  ...
  /// Can be used on: https://ref.gs1.org/voc/CertificationDetails
  ///
  static const gs1CertificationStatement = IriTerm(
    'https://ref.gs1.org/voc/certificationStatement',
  );

  /// certificationStatus from gs1 vocabulary [Expects: https://ref.gs1.org/voc/CertificationStatus]
  ///
  /// Indicates the current status of the certification, e.g. active or inactive.
  ///
  /// Can be used on: https://ref.gs1.org/voc/CertificationDetails
  ///
  static const gs1CertificationStatus = IriTerm(
    'https://ref.gs1.org/voc/certificationStatus',
  );
  ...
  /// certificationType from gs1 vocabulary [Expects: http://www.w3.org/2002/07/owl#Thing]
  ///
  /// Indicates the type of certification
  ///
  /// Can be used on: https://ref.gs1.org/voc/CertificationDetails
  ///
  static const gs1CertificationType = IriTerm(
    'https://ref.gs1.org/voc/certificationType',
  );

  /// certificationURI from gs1 vocabulary [Expects: http://www.w3.org/2001/XMLSchema#anyURI]
  ///
  ...
  /// Can be used on: https://ref.gs1.org/voc/CertificationDetails
  ///
  static const gs1CertificationURI = IriTerm(
    'https://ref.gs1.org/voc/certificationURI',
  );

  /// certificationValue from gs1 vocabulary [Expects: http://www.w3.org/1999/02/22-rdf-syntax-ns#langString]
  ///
  /// The certification's standard value. Example: '4'.
  ///
  /// Can be used on: https://ref.gs1.org/voc/CertificationDetails
  ///
  static const gs1CertificationValue = IriTerm(
  ...
  /// initialCertificationDate from gs1 vocabulary [Expects: http://www.w3.org/2001/XMLSchema#date]
  ///
  ...
  /// Can be used on: https://ref.gs1.org/voc/CertificationDetails
  ///
  static const gs1InitialCertificationDate = IriTerm(
    'https://ref.gs1.org/voc/initialCertificationDate',
  );
