...
/// Corporation class from SchemaHttp vocabulary
///
...
///
/// This class provides access to all properties that can be used with Corporation.
/// [Class Reference](http://schema.org/Corporation)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpCorporation {
  // Private constructor prevents instantiation
  const SchemaHttpCorporation._();

  /// IRI term for the Corporation class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('http://schema.org/Corporation');
  ...
  /// tickerSymbol [Expects: http://schema.org/Text]
  ///
