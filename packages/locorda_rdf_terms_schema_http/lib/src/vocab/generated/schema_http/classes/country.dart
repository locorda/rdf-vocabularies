...
/// Country class from SchemaHttp vocabulary
///
/// A country.
///
/// Inherits from:
/// - AdministrativeArea (http://schema.org/AdministrativeArea)
/// - GeographicRegion (https://www.omg.org/spec/LCC/Countries/CountryRepresentation/GeographicRegion)
/// - GeopoliticalEntity (https://www.omg.org/spec/Commons/GeopoliticalEntities/GeopoliticalEntity)
/// - GeopoliticalEntity (https://www.omg.org/spec/LCC/Countries/CountryRepresentation/GeopoliticalEntity)
/// - Location (https://www.omg.org/spec/LCC/Countries/CountryRepresentation/Location)
...
///
/// Equivalent to:
/// - Country (http://unece.org/vocab#Country)
/// - Country (https://ref.gs1.org/voc/Country)
/// - Country (https://www.omg.org/spec/LCC/Countries/CountryRepresentation/Country)
/// - Country (https://gs1.org/voc/Country)
/// - Country (https://www.gs1.org/voc/Country)
/// - Location (https://www.omg.org/spec/Commons/Locations/Location)
/// - Subdivision (https://www.omg.org/spec/Commons/GeopoliticalEntities/Subdivision)
///
/// This class provides access to all properties that can be used with Country.
/// [Class Reference](http://schema.org/Country)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpCountry {
  // Private constructor prevents instantiation
  const SchemaHttpCountry._();

  /// IRI term for the Country class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('http://schema.org/Country');
  ...
  /// countryCode from gs1 vocabulary [Expects: http://www.w3.org/2001/XMLSchema#string]
  ///
  /// Code specifying the country for the address using ISO 3166-1.
  ///
  /// Can be used on: https://ref.gs1.org/voc/Country
  ///
  static const gs1CountryCode = IriTerm('https://ref.gs1.org/voc/countryCode');
  ...
  /// hasSubregion from lcc-cr vocabulary [Expects: https://www.omg.org/spec/LCC/Countries/CountryRepresentation/GeographicRegion]
  ///
  ///
  ///
  /// Can be used on: https://www.omg.org/spec/LCC/Countries/CountryRepresentation/GeographicRegion
  ///
  static const lccCrHasSubregion = IriTerm(
    'https://www.omg.org/spec/LCC/Countries/CountryRepresentation/hasSubregion',
  );

  /// isSubregionOf from lcc-cr vocabulary [Expects: https://www.omg.org/spec/LCC/Countries/CountryRepresentation/GeographicRegion]
  ///
  ///
  ///
  /// Can be used on: https://www.omg.org/spec/LCC/Countries/CountryRepresentation/GeographicRegion
  ///
  static const lccCrIsSubregionOf = IriTerm(
    'https://www.omg.org/spec/LCC/Countries/CountryRepresentation/isSubregionOf',
  );

  /// usesAdministrativeLanguage from lcc-cr vocabulary [Expects: https://www.omg.org/spec/LCC/Languages/LanguageRepresentation/Language]
  ///
  ///
  ///
  /// Can be used on: https://www.omg.org/spec/LCC/Countries/CountryRepresentation/GeopoliticalEntity
  ///
  static const lccCrUsesAdministrativeLanguage = IriTerm(
    'https://www.omg.org/spec/LCC/Countries/CountryRepresentation/usesAdministrativeLanguage',
  );

  /// hasRemarks from lcc-cr vocabulary [Expects: http://www.w3.org/2001/XMLSchema#string]
  ///
  ///
  ///
  /// Can be used on: https://www.omg.org/spec/LCC/Countries/CountryRepresentation/GeopoliticalEntity
  ///
  static const lccCrHasRemarks = IriTerm(
    'https://www.omg.org/spec/LCC/Countries/CountryRepresentation/hasRemarks',
  );

  /// isIndependent from lcc-cr vocabulary [Expects: http://www.w3.org/2001/XMLSchema#boolean]
  ///
  ///
  ///
  /// Can be used on: https://www.omg.org/spec/LCC/Countries/CountryRepresentation/GeopoliticalEntity
  ///
  static const lccCrIsIndependent = IriTerm(
