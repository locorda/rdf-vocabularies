...
/// DigitalDocumentPermission class from SchemaHttp vocabulary
///
...
///
/// This class provides access to all properties that can be used with DigitalDocumentPermission.
/// [Class Reference](http://schema.org/DigitalDocumentPermission)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpDigitalDocumentPermission {
  // Private constructor prevents instantiation
  const SchemaHttpDigitalDocumentPermission._();

  /// IRI term for the DigitalDocumentPermission class
  ...
  /// grantee [Expects: http://schema.org/Audience, http://schema.org/ContactPoint, http://schema.org/Organization, http://schema.org/Person]
  ///
