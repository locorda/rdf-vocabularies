...
/// Duration class from SchemaHttp vocabulary
///
...
/// - TimeInterval (https://www.omg.org/spec/Commons/DatesAndTimes/TimeInterval)
///
/// Equivalent to:
/// - Duration (https://www.omg.org/spec/Commons/DatesAndTimes/Duration)
///
/// This class provides access to all properties that can be used with Duration.
/// [Class Reference](http://schema.org/Duration)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpDuration {
  // Private constructor prevents instantiation
  const SchemaHttpDuration._();

  /// IRI term for the Duration class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('http://schema.org/Duration');
  ...
  /// hasDurationValue from cmns-dates vocabulary [Expects: http://www.w3.org/2001/XMLSchema#string]
  ///
  ///
  ///
  /// Can be used on: https://www.omg.org/spec/Commons/DatesAndTimes/Duration
  ///
  static const cmnsDatesHasDurationValue = IriTerm(
