...
/// WarrantyPromise class from SchemaHttp vocabulary
///
...
/// - MutualContractualAgreement (https://spec.edmcouncil.org/fibo/ontology/FND/Agreements/Contracts/MutualContractualAgreement)
/// - Resource (http://www.w3.org/2000/01/rdf-schema#Resource)
/// - Situation (https://www.omg.org/spec/Commons/PartiesAndSituations/Situation)
/// - StructuredValue (http://schema.org/StructuredValue)
/// - Thing (http://schema.org/Thing)
/// - Thing (http://www.w3.org/2002/07/owl#Thing)
///
/// This class provides access to all properties that can be used with WarrantyPromise.
/// [Class Reference](http://schema.org/WarrantyPromise)
///
/// [Vocabulary Reference](http://schema.org/)
class SchemaHttpWarrantyPromise {
  // Private constructor prevents instantiation
  const SchemaHttpWarrantyPromise._();

  /// IRI term for the WarrantyPromise class
  /// Use this to specify that a resource is of this type.
  static const classIri = IriTerm('http://schema.org/WarrantyPromise');
  ...
  /// durationOfWarranty [Expects: http://schema.org/QuantitativeValue]
  ///
  ...
  /// warrantyScope [Expects: http://schema.org/WarrantyScope]
  ///
  ...
  /// hasContractualElement from fibo-fnd-agr-ctr vocabulary [Expects: https://spec.edmcouncil.org/fibo/ontology/FND/Agreements/Contracts/ContractualElement]
  ///
  ///
  ///
  /// Can be used on: https://spec.edmcouncil.org/fibo/ontology/FND/Agreements/Agreements/Agreement
  ///
  static const fiboFndAgrCtrHasContractualElement = IriTerm(
    'https://spec.edmcouncil.org/fibo/ontology/FND/Agreements/Contracts/hasContractualElement',
  );

  /// hasMilestoneProvision from fibo-fnd-agr-ctr vocabulary [Expects: https://spec.edmcouncil.org/fibo/ontology/FND/Agreements/Contracts/ContractMilestone]
  ///
  ///
  ///
  /// Can be used on: https://spec.edmcouncil.org/fibo/ontology/FND/Agreements/Agreements/Agreement
  ///
  static const fiboFndAgrCtrHasMilestoneProvision = IriTerm(
    'https://spec.edmcouncil.org/fibo/ontology/FND/Agreements/Contracts/hasMilestoneProvision',
  );

  /// hasNonBindingTerm from fibo-fnd-agr-ctr vocabulary [Expects: https://spec.edmcouncil.org/fibo/ontology/FND/Agreements/Contracts/NonBindingTerm]
  ///
  ///
  ///
  /// Can be used on: https://spec.edmcouncil.org/fibo/ontology/FND/Agreements/Agreements/Agreement
  ///
  static const fiboFndAgrCtrHasNonBindingTerm = IriTerm(
    'https://spec.edmcouncil.org/fibo/ontology/FND/Agreements/Contracts/hasNonBindingTerm',
  );
  ...
  /// hasActor from cmns-parties vocabulary [Expects: https://www.omg.org/spec/Commons/PartiesAndSituations/Actor]
  ///
  ///
  ///
  /// Can be used on: https://www.omg.org/spec/Commons/PartiesAndSituations/Situation
  ///
  static const cmnsPartiesHasActor = IriTerm(
    'https://www.omg.org/spec/Commons/PartiesAndSituations/hasActor',
  );

  /// hasSubjectRole from cmns-parties vocabulary [Expects: https://www.omg.org/spec/Commons/RolesAndCompositions/Role]
  ///
  ///
  ///
  /// Can be used on: https://www.omg.org/spec/Commons/PartiesAndSituations/Situation
  ///
  static const cmnsPartiesHasSubjectRole = IriTerm(
    'https://www.omg.org/spec/Commons/PartiesAndSituations/hasSubjectRole',
  );

  /// hasUndergoer from cmns-parties vocabulary [Expects: https://www.omg.org/spec/Commons/PartiesAndSituations/Undergoer]
  ///
  ///
  ///
  /// Can be used on: https://www.omg.org/spec/Commons/PartiesAndSituations/Situation
  ///
  static const cmnsPartiesHasUndergoer = IriTerm(
    'https://www.omg.org/spec/Commons/PartiesAndSituations/hasUndergoer',
  );
}
